            ...
            child: Column(
              ...
              children: [
                ...
                RoomInfoWidget(
                    ...
                    mypersonnum: controller.sendRequest.value.members!.length,
                    yourpersonnum: controller.sendRequest.value.members!.length,
                    gender: controller.sendRequest.value.joinInfo.gender,
                    univ: controller.sendRequest.value.joinInfo.uni),
                    if(stateManagement == StateManagement.friendReject || stateManagement == StateManagement.theyReject)
                Column(
                  children: [
                    ...
                    Text("'${controller
                        .sendRequest
                        .value
                        .members![controller.sendRequest.value.members!
                            .indexWhere((e) => e.type == 2)]
                        .nickname.toString()}'님이 함께 가기를 거절했어요", style: kInActiveButtonStyle.copyWith(color: kred)),
                    const SizedBox(height: 12),
                    PrimaryButton(text: '신청 다시 보내기', isactive: true.obs,)
                  ],
                )
              ],
            ),
