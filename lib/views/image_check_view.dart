...
class ImageCheckView extends StatelessWidget {
        ...
        body: Padding(
          ...
          child:
                ...
                child: Container(
                  ...
                  child: ProfileController.to.profile.value.profileImage == '' 
                      ? Column(
                          ...
                          children: [
                            SvgPicture.asset('assets/icons/image_update.svg')
                          ],
                        )
                      : CachedNetworkImage(imageUrl: ProfileController.to.profile.value.profileImage.replaceAll('https', 'http'),fit: BoxFit.cover,),
                ),
              ),
            ),
            ...
            GestureDetector(
                ...
                child: PrimaryButton(text: '친구 만나러 가기', isactive: true.obs))
          ]),
        ),
      ),
    );
  ...
  XFile? check_image = await ImagePicker().pickImage(source: ImageSource.gallery);
