...
class SendRequestDetailController extends GetxController{
  SendRequestDetailController({required this.id, required this.stateManagement});
  int id;
  StateManagement stateManagement;
  Rx<SendRequest> sendRequest = SendRequest(id: 0, joinInfo: JoinInfo(id: 0, introduction: '', type: 0,age: 0, uni: '',gender: 'M' ), type: 0,members: <Host>[]).obs;
  ...
  Future getSendRequest()async{
   ...
   if(httpResponse.isError == false){
     ...
     morerequeststate.value = Screenstate.error;
   };});
  }
}