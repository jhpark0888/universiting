  ...
  Widget selectTypeText(AlarmReceive alarmreceive) {
    if (alarmreceive.type == 1) {
      return RichText(
        ...
        TextSpan(
            text:
                "${alarmreceive.profile.nickname}님이 회원님을 '${alarmreceive.content!.title}'",
            style: kBodyStyle1),
        TextSpan(text: '방에 초대했어요', style: kBodyStyle1.copyWith(color: kPrimary))
      ]));
    } else if (alarmreceive.type == 2) {
      return RichText(
          text: TextSpan(children: [
      ...
      return RichText(
          text: TextSpan(children: [
        TextSpan(
            text: "'${alarmreceive.roomInformation}'방의 친구 중 방을 나간 친구가 있어 ",
            style: kBodyStyle1),
        TextSpan(
            text: '방이 삭제되었어요', style: kBodyStyle1.copyWith(color: kPrimary))
      ]));
    }
    return RichText(
        text: TextSpan(children: [
