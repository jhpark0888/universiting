...
class SendRequestWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      } else if (request.requeststate!.value == StateManagement.theyReject) {
        ...
        showCustomDialog('다음 기회에', 1200);
                    ...
                    : Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text('수락하여 새로운 친구를 만나보세요', style: k16Medium),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      roomRequestJoin(request.room!.id!, 'join',
                                              request.members!.first.userId)
                                          .then((httpresponse) {
                                        if (httpresponse.isError == false) {
                                        } else {}
          ...
          GestureDetector(
            onTap: (){
              if (request.requeststate!.value != StateManagement.theyReject){
                Get.to(() => RoomDetailView(roomid: request.room!.id!.toString()));
              }
            },
            child: Column(
